<?php
namespace Devdebug\whoops;

use Pimple\Container;
use Rarst\wps\Admin_Ajax_Handler;
...
require 'class-admin-ajax-handler.php';
require 'class-rest-api-handler.php';

class DevDebugWhoops extends Container {
	...
	public function __construct( $values = array() ) {
		...
		$defaults['handler.json'] = function () {
			$handler = new \Devdebug\whoops\Admin_Ajax_Handler();
	...
	public function run() {
		...
		/** @var Run $run */
		// Or we are going to be spitting out WP markup before whoops.
	}
}
