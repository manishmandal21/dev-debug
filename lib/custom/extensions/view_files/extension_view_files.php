...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_view_files' ) ) {


    /**
     * Main ReduxFramework view_files extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_extension_view_files {
